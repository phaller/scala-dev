...
object SourceInfoManifest {
  /** Manifest for the class type `clazz[args]', where `clazz' is
    ...
    */
  def classType[T](line: Int, clazz: Predef.Class[_]): SourceInfoManifest[T] =
    new ClassTypeManifest[T](line, None, clazz, Nil)

  /** Manifest for the class type `clazz', where `clazz' is
    * a top-level or static class and args are its type arguments. */
  def classType[T](line: Int, clazz: Predef.Class[T], arg1: Manifest[_], args: Manifest[_]*): SourceInfoManifest[T] =
    new ClassTypeManifest[T](line, None, clazz, arg1 :: args.toList)

  /** Manifest for the class type `clazz[args]', where `clazz' is
    * a class with non-package prefix type `prefix` and type arguments `args`.
    */
  def classType[T](line: Int, prefix: Manifest[_], clazz: Predef.Class[_], args: Manifest[_]*): SourceInfoManifest[T] =
    new ClassTypeManifest[T](line, Some(prefix), clazz, args.toList)

  /** Manifest for the class type `clazz[args]', where `clazz' is
    * a top-level or static class. */
  private class ClassTypeManifest[T](lineInfo: Int,
